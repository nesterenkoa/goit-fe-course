...
const userInput = prompt(numText); // строка, которую ввел пользователь
const number = Number.parseInt(userInput); // приводим строку к числовому значению
if (userInput == null) {
  alert(cancelText)
